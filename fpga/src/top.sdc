...
set_clock_groups -asynchronous -group [get_clocks {clk}] -group [get_clocks {clk108 clk108p}] -group [get_clocks {clk135}]
// clk54 clk_audio}] -group [get_clocks {clk_sound clk_opll}]  -group [get_clocks {clock}]