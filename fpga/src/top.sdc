...
//create_clock -name clock -period 34.916 -waveform {0 17.458} [get_ports {clock}] -add
...
//set_clock_groups -asynchronous -group [get_clocks {clk}] -group [get_clocks {clock}] -group [get_clocks {clk108 clk108p clk54}] -group [get_clocks {clk135 clk_audio}] -group [get_clocks {clk_sound clk_opll}]